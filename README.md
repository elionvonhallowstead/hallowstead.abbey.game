...
Any books submitted to the website or the [Discord Server](https://discord.com/invite/zHS6av77ws) are meant to be implemented within this game. (We still ask for consent).
 If you want to submit a book, or essay, or similar, you can do so using a [form](https://forms.ifnul.com/forms/5dcffeb5-aecb-4ca2-aa99-52cb1f7872f3), in the [Discord Server](https://discord.com/invite/zHS6av77ws), or via [email](mailto:elionvonhallowstead+submit-book@gmail.com).
